...
def main():
    map_file_path = "./Embedding_Preprocessing/slt_encoder.tsv" 
    config_file_path = "./Configuration/config/config_1"
    ...
    if train_model:
        ...
        if do_retrieval:
            ...
            system.create_result_file(retrieval_result, "./Retrieval_Results/slt_res.tsv", "1")
    else:
